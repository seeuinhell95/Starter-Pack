...
StartWeapons_OnPluginStart()
{
	...
	{
		gH_Cvar_CT_Weapons = CreateConVar("sm_hosties_ct_start", "weapon_knife,weapon_hegrenade,weapon_deagle,weapon_m4a1", "Comma delimitted list of items to give to CTs at spawn", 0);
		Format(gShadow_CT_Weapons, sizeof(gShadow_CT_Weapons), "weapon_knife,weapon_hegrenade,weapon_deagle,weapon_m4a1");
	}
	UpdateStartWeapons();	
