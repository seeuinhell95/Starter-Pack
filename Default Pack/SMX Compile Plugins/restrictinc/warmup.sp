...
bool StartWarmup()
{
	...
	BuildPath(Path_SM, szPreConfig, sizeof(szPreConfig), "configs/WeaponRestrict/prewarmup.cfg");
	RunFile(szPreConfig);
...
CSWeaponID GetWarmupWeapon()
{
	...
	BuildPath(Path_SM, szWarmupConfig, sizeof(szWarmupConfig), "configs/WeaponRestrict/warmup.cfg");
...
void EndWarmup()
{
	...
	BuildPath(Path_SM, szPostConfig, sizeof(szPostConfig), "configs/WeaponRestrict/postwarmup.cfg");
