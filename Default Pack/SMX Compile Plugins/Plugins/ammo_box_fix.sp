...
{
	name = "[CSGO] Ammo Box Fix",
	author = "Indarello | Edited: somebody.",
	description = "Ammo Box Fix",
	version = "1.0",
...
public Action OnWeaponEquipPost(int client, int weapon)
{
	...
	int ammotype = GetEntData(weapon, g_iOffsetPrimaryAmmoType);
	int offset = g_iOffsetAmmo + (ammotype * 4);
	int ammo = GetEntData(client, offset);
	if(ammo != -1)
	{
		DataPack pack;
		CreateDataTimer(0.01, ReserveAmmoTimer1, pack);
