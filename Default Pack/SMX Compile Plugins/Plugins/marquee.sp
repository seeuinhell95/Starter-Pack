...
{
	name = "[CSGO] Marquee",
	author = "Jannik \"Peace-Maker\" Hartung | Edited: somebody.",
	description = "Marquee",
	version = "1.0",
...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_marque", Cmd_Marquee, ADMFLAG_CHAT, "Sends a marquee text panel to the target. Usage: sm_marque <#userid|steamid|name> TEXT");
}
