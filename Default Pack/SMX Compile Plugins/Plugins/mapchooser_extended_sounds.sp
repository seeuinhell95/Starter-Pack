...
#define CONFIG_FILE "configs/mapchooser/sounds.cfg"
#define CONFIG_DIRECTORY "configs/mapchooser"
...
public Plugin myinfo =
{
	...
	author = "PowerLord & TotenFluch | Edited: somebody.",
...
public OnPluginStart()
{
	...
	g_Cvar_SoundSet = CreateConVar("mce_sounds_soundset", "csgo", "Sound set to use, optimized for TF by default.  Sound sets are defined in addons/sourcemod/configs/mapchooser/sounds.cfg.  Takes effect immediately if sm_mapvote_downloadallsounds is 1, otherwise at map change.", FCVAR_NONE);
