...
{
	name = "[CSGO] RNG Fix",
	author = "Riot | Edited: somebody.",
	description = "RNG Fix",
	version = "1.0",
	url = "http://sourcemod.net"
}

#define LAND_HEIGHT 2.0
#define NON_JUMP_VELOCITY 140.0
#define MIN_STANDABLE_ZNRM 0.7
#define AIR_SPEED_CAP 30.0
#define DUCK_MIN_DUCKSPEED 1.5
#define DEFAULT_JUMP_IMPULSE 301.99337741
...
public void OnPluginStart()
{
	...
	g_cvUphill 		= CreateConVar("rngfix_uphill", "0", "Enable uphill incline fix. Set to -1 to normalize effects not in the player's favor (not recommended).", FCVAR_NOTIFY, true, -1.0, true, 1.0);
