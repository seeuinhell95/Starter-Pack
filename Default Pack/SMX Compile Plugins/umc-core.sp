...
{
    name        = "[CSGO] Ultimate MapChooser - Core",
    author      = "Steell, PowerLord & Mr. Silence | Edited: somebody.",
    description = "Ultimate MapChooser - Core",
    version     = "1.0",
...
new bool:change_map_round;

new Handle:cvar_maxrounds = INVALID_HANDLE;
new Handle:cvar_fraglimit = INVALID_HANDLE;
new Handle:cvar_winlimit  = INVALID_HANDLE;
new Handle:cvar_nextlevel = INVALID_HANDLE;
new Handle:cvar_zpsmaxrnds = INVALID_HANDLE;
new Handle:cvar_zpomaxrnds = INVALID_HANDLE;
...
public OnPluginStart()
{
    ...
    AutoExecConfig(true, "umc/ultimate-mapchooser");
...
public Action:OnPlayerChat(client, const String:command[], argc)
{
    ...
    {
        PrintToChat(client,"[SM] Ultimate Mapchooser (UMC) Plugin v1.0 ");
    }
    return Plugin_Continue;
}
...
{   
    ...
    switch (when)
    {
        ...
        case ChangeMapTime_RoundEnd: //We change the map at the end of the round.
        {
            ...
            //Print a message.
            PrintToChatAll("[\x04UMC\x01] %t", "Map Change at Round End");
        }
    }
}
