...
{
	LoadTranslations("playercolors.phrases");

	c_color = RegClientCookie("PlayerColors", "PlayerColors", CookieAccess_Private);

	RegAdminCmd("sm_playercolors", Colores, ADMFLAG_RESERVATION);
	RegAdminCmd("sm_playercolor", Colores, ADMFLAG_RESERVATION);
	RegAdminCmd("sm_pcolors", Colores, ADMFLAG_RESERVATION);
	RegAdminCmd("sm_pcolor", Colores, ADMFLAG_RESERVATION);
	RegAdminCmd("sm_colors", Colores, ADMFLAG_RESERVATION);
	RegAdminCmd("sm_color", Colores, ADMFLAG_RESERVATION);
