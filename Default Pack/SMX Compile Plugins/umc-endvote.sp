...
{
    name        = "[CSGO] UMC - End of Map Vote",
    author      = "Steell, PowerLord & Mr. Silence | Edited: somebody.",
    description = "UMC - End of Map Vote",
    version     = "1.0",
...
new bool:timer_alive;
new bool:vote_enabled;
new bool:vote_roundend;
new bool:vote_completed;
new bool:vote_failed;
...
public OnPluginStart()
{
    ...
    AutoExecConfig(true, "umc/umc-endvote");
