...
#define COMM_TABLE_PREVIOUS "extendedcomm"
...
{
	name = "[CSGO] ExtendedComm",
	author = "Twisted Panda | Edited: somebody.",
	description = "ExtendedComm",
...
public OnPluginStart()
{
	...
	g_hConnection = CreateConVar("extendedcomm_database", "extendedcomm", "The database configuration for ExtendedComm. Use \"\" to connect to a local sqlite database.", FCVAR_NONE);
	...
	RegAdminCmd("sm_commslist", Command_List, ADMFLAG_CHAT, "Extended Comm: Provides functionality for viewing current comm punishments.");
	RegAdminCmd("sm_comms", Command_List, ADMFLAG_CHAT, "Extended Comm: Provides functionality for viewing current comm punishments.");
	RegAdminCmd("sm_mutelist", Command_List, ADMFLAG_CHAT, "Extended Comm: Provides functionality for viewing current comm punishments.");
