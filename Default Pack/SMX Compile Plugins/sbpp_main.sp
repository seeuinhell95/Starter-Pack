...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_fakedcban", CommandBanDC, ADMFLAG_BAN, "sm_fakedcban <#userid|name> <minutes|0> [reason]", "sourcebans");
...
public Action CommandBanDC(client, args)
{
...
stock void DisplayBanTimeMenu(int client)
{
	...
	char title[100];
	FormatEx(title, sizeof(title), "%T:", "Ban time", client);
