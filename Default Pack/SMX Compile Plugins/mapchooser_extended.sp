...
public Plugin myinfo =
{
	...
	author = "PowerLord, Zuko, TotenFluch & AlliedModders LLC | Edited: somebody.",
...
public OnPluginStart()
{
	...
	g_Cvar_ExtendTimeStep = CreateConVar("mce_extend_timestep", "9999", "Specifies how much many more minutes each extension makes", _, true, 5.0);
	...
	RegAdminCmd("mce_reload_maplist", Command_ReloadMaps, ADMFLAG_CHEATS, "mce_reload_maplist - Reload the Official Maplist file.");
