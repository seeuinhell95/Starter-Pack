...
public void OnPluginStart()
{
	...
	RegConsoleCmd("sm_lastmover", 	CMD_LastMover, 		"Last mover");
	RegConsoleCmd("sm_bbrespawn", 	CMD_Respawn,		"Respawn");
	RegConsoleCmd("sm_bbspawn", 	CMD_Respawn,		"Respawn");
	RegConsoleCmd("sm_bbrevive", 	CMD_Respawn,		"Respawn");
	RegConsoleCmd("sm_bbcolors", 	CMD_Colors,			"Colors");
	RegConsoleCmd("sm_bbcolor", 	CMD_Colors,			"Colors");
	RegConsoleCmd("sm_class", 		CMD_ZMClass, 		"Change class");
	RegConsoleCmd("sm_zclass", 		CMD_ZMClass, 		"Change class");
	RegConsoleCmd("sm_zombi", 		CMD_ZMClass, 		"Change class");
	RegConsoleCmd("sm_zombie", 		CMD_ZMClass, 		"Change class");
	RegConsoleCmd("sm_zombies", 	CMD_ZMClass, 		"Change class");
	RegConsoleCmd("sm_bbshop", 		CMD_Shop, 			"Open shop");
	RegConsoleCmd("sm_guns", 		CMD_Guns,			"Guns menu");
	RegConsoleCmd("sm_gun", 		CMD_Guns,			"Guns menu");
	RegConsoleCmd("sm_weapons", 	CMD_Guns,			"Guns menu");
	RegConsoleCmd("sm_weapon", 		CMD_Guns,			"Guns menu");
	RegConsoleCmd("sm_bbadmin", 	CMD_AdminPanel,		"Admin panel");
	RegConsoleCmd("sm_bbmenu", 		CMD_AdminPanel,		"Admin panel");
	RegConsoleCmd("sm_deleteblock", CMD_DeleteBlock,	"Delete block");
...
{
	if(Client_HasAdminFlags(client, ADMFLAG_GENERIC) || Client_HasAdminFlags(client, ADMFLAG_GENERIC) || Client_HasAdminFlags(client, ADMFLAG_GENERIC))
		return true;
	else return false;
}
