#define PREFIX "[\x04Soccer Mod\x01]"
...
{
    name            = "[CSGO] Soccer Mod",
    author          = "Marco Boogers | Edited: somebody.",
    description     = "Soccer Mod",
    version         = "1.0",
...
{
    BuildPath(Path_SM, allowedMapsConfigFile, sizeof(allowedMapsConfigFile), "configs/soccer_mod/maps.txt");
