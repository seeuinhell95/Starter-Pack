...
public void ClientCommandSetGoalkeeperSkin(int client)
{
    ...
    if (skinsIsGoalkeeper[client])
    {
        ...
        PrintToChat(client, "[\x04Soccer Mod\x01] %t", "Goalkeeper skin disabled");
    }
    else
    {
        ...
        PrintToChat(client, "[\x04Soccer Mod\x01] %t", "Goalkeeper skin enabled");
    }
}
...
{
    BuildPath(Path_SM, skinsKeygroup, sizeof(skinsKeygroup), "configs/soccer_mod/skins.txt");
